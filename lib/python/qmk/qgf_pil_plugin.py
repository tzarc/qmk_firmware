...
from PIL._binary import i8, o8, i16le as i16, o16le as o16, i32le as i32, o32le as o32
...
class QGFFrameOffsetDescriptorV1:
    ...
    def __init__(self, frame_count):
        ...
        self.frame_offsets = [-1 & 0xFFFFFFFF] * frame_count
...
class QGFFrameDescriptorV1:
    ...
    def __init__(self):
        ...
        self.format = (-1 & 0xFF)
        self.flags = 0
        self.compression = (-1 & 0xFF)
        self.transparency_index = (-1 & 0xFF)
        self.delay = (-1 & 0xFFFF)
    ...
    def _write_frame(idx, frame, last_frame):
        ...
        if use_deltas and last_frame is not None:
            ...
            if bbox:
                ...
                # Work out how large the delta frame is going to be
                ...
                # If the size of the delta frame (plus descriptor) is smaller than the original, use that instead
